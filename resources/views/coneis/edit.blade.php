        ...
        <form action="{{route('coneis.update', $conei->id)}}" method="POST">
            ...
            <section class="mt-3">
                ...
                <div class="form-group pt-2 mt-1">
                    ...
                    <input type="text" class="form-control w-100" value="{{$conei->number}}">
                </div>
                <div class="form-group pt-2 mt-1">
                    <label class="font-weight-bold" for="folder">Anillado</label>
                    <input type="text" name="folder" class="form-control w-100" id="folder" value="{{$conei->folder}}">
                </div>
                <div class="form-group pt-2 mt-1">
                    <label class="font-weight-bold" for="phone">Archivo</label>
                    <input type="text" name="binder" class="form-control w-100" id="binder" value="{{$conei->binder}}">
                </div>
                <div class="form-group pt-2 mt-1 periods">
                    <label class="font-weight-bold">Periodos</label>
                    <input type="hidden" name="period" class="form-control w-100" value="{{$conei->period}}" id="period">
                    @php
                        $periods = explode('-', $conei->period);
                        $years = [];
