...
@endif
<div class="box-header py-3 mb-2">Lista de apafas</div>
<div class="box-body">
    <div class="my-2 py-2 px-3 mx-1">
        <div class="row">
            ...
            <div class="col-7 d-flex justify-content-end">
                <a href="{{route('export', ['table' => 'Apafas'])}}" class="btn btn-light mx-2">
        ...
        <table class="w-100">
            ...
            <tbody class="table-body">
                @foreach ($schools as $school)
                    @foreach ($school->apafas as $apafa)
                        <tr class="row mx-0 px-2" id="apafa{{$apafa->id}}">
                            <td class="col-4 px-3">
                                @php
